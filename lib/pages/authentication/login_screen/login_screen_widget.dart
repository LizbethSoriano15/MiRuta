...
class _LoginScreenWidgetState extends State<LoginScreenWidget>
  ...
  void initState() {
    ...
    _model.textController3 ??= TextEditingController(text: 'MiRuta');
    _model.textFieldFocusNode3 ??= FocusNode();

    _model.textController4 ??= TextEditingController(text: 'yovoy');
    _model.textFieldFocusNode4 ??= FocusNode();

    _model.textController5 ??=
        TextEditingController(text: 'miruta.yovoy@gmail.com');
                ...
                children: [
                  Align(
                    ...
                    child: Container(
                      ...
                      child: Image.asset(
                        'assets/images/Imagen_de_WhatsApp_2025-03-27_a_las_14.49.04_85f9b0bb.jpg',
                        fit: BoxFit.cover,
                      ),
                    ),
                  ),
